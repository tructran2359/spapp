...
class HomePromotionAdapter(
    ...
    private var mListener: OnPromotionClickListener? = null
    ...
    inner class TopCatePromotionVH(itemView: View) : RecyclerView.ViewHolder(itemView) {

        init {
            itemView.setOnClickListener {
                mListener?.onPromotionClick(adapterPosition)
            }
        }
    }
